...
describe MagicWarAxe do
  Given(:axe) { MagicWarAxe.new }
  ...
  context "when attacking" do
    ...
    context "when wielded by a non-rogue" do
      ...
      Then { attack.normal_damage.should == basic_damage + 6 + 2 }
      Then { attack.critical_damage.should == 3*(basic_damage + 6 + 2) }
    end
    ...
    context "when normal attack" do
      ...
      Then { attack.attack_value.should == basic_attack + 2 }
      Then { attack.normal_damage.should == basic_damage + 6 + 2 }
      Then { attack.critical_damage.should == 4*(basic_damage + 6 + 2) }
    end
  end
end
